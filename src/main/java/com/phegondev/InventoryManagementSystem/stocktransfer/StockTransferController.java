...
public class StockTransferController {
    ...
    @PostMapping("/add")
    @PreAuthorize("hasAnyAuthority('ADMIN','SUPER_ADMIN','MANAGER','BRANCH_MANAGER','INVENTORY_STAFF')")
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN','SUPER_ADMIN','MANAGER','BRANCH_MANAGER')")
